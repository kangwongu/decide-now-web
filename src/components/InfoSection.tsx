      ...
      <div className="flex flex-col gap-[16px]">
        ...
        <article className="bg-bg-card rounded-[20px] p-[24px] border-[1.5px] border-[rgba(245,158,11,0.15)]">
          ...
          <p className="text-[14px] leading-[1.8] text-text-sub">
            우리는 하루에도 수많은 크고 작은 결정을 내립니다. 결정이
            반복될수록 뇌는 지치고, 판단력은 급격히 떨어집니다. 2011년
            Danziger 등의 연구에 따르면, 이스라엘 판사들의 가석방 승인률이
            휴식 직후에는 약 65%였지만 시간이 지날수록 크게 하락하는 패턴이
            관찰되었습니다. 피로해진 뇌는 &lsquo;현상 유지&rsquo;를 택하게
            되고, 이것이 바로 결정 장애의 핵심 원인입니다.
          </p>
        </article>
        ...
        <article className="bg-bg-card rounded-[20px] p-[24px] border-[1.5px] border-[rgba(245,158,11,0.15)]">
          ...
          <p className="text-[14px] leading-[1.8] text-text-sub">
            ...
            30%로 10배나 높았습니다. 선택지가 너무 많으면 &lsquo;더 나은 선택이
